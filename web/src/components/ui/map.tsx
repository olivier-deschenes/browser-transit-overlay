...
// MapLibre looks for its worker beside its own module, which a bundle does not
// keep, so the worker is bundled with the site and served from it rather than
// fetched from a CDN on every visit.
if (typeof window !== 'undefined') {
  MapLibreGL.setWorkerUrl(workerUrl)
}

// OpenFreeMap's styles need no key. Carto's basemaps, mapcn's own default, now
// stamp "API KEY REQUIRED" across their tiles.
const defaultStyles = {
